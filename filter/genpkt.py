...
pkts.append(pkt);
pkt = Ether()/IP(version=4,src="1.2.3.4",dst="8.8.8.8")/UDP(sport=12345,dport=233)/"hello world"
pkts.append(pkt);
pkt = Ether()/IP(version=4,src="5.6.7.8",dst="9.9.9.9")/UDP(sport=7777,dport=23)/"hello world"
pkts.append(pkt);
pkt = Ether()/IP(version=4,src="5.6.7.8",dst="9.9.9.9")/UDP(sport=7777,dport=23)/"Data Plane Development Kit"
pkts.append(pkt);
