jumbo frame, IP分片, timestamp等mbuf相关验证:

* 打开jumbo frame设置, mtu=500
* 打开timestamp设置
...
运行命令::
    ...
    ./l2fwd2 -l 7-10 -n 4 -- -p 0x3 --config="(0,0,7),(0,1,8),(1,0,9),(1,1,10)"

如果只用了一个仪表口向设备上的网卡0发送流量, 而设备上的网卡1短接, 那么还需要加上\
-P参数打开混杂模式::

    ./l2fwd2 -l 7,8 -n 4 -- -p 0x3 -P --config="(0,0,7),(1,0,8)"
    ./l2fwd2 -l 7-10 -n 4 -- -p 0x3 -P --config="(0,0,7),(0,1,8),(1,0,9),(1,1,10)"
    ./l2fwd2 -l 6-11 -n 4 -- -p 0x3 -P --config="(0,0,6),(0,1,7),(0,2,8),(1,0,9),(1,1,10),(1,2,11)"
